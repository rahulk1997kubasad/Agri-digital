...
public class LandRequestDetailsActivity extends AppCompatActivity {
    private String area,soil,landmark,cost,year,description,id,contact,farmer_id,user_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (language.equals("English")) {
            setContentView(R.layout.activity_land_request_details);
        }
        else
        {
            setContentView(R.layout.kactivity_land_request_details);
        }
