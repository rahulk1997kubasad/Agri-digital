...
public class EquipmentRequestDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (language.equals("English")) {
            setContentView(R.layout.activity_equipment_request_details);
        }
        else
        {
            setContentView(R.layout.kactivity_equipment_request_details);
        }
...
//        String rfarmer_id=object.getString("rfarmer_id");
    ...
    private void getDetails(final String object_id, final String request_for) {
        ...
        Log.d("ERROR", "getDetails: "+API);
        Log.d("ERROR@"," object_id :"+object_id+"  ef" +request_for);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, API,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
